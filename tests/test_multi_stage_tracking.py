...
def test_handle_tracklets():
    exp_trks = np.array(
        [
            ...
            [1, 192, 11, 1127, 417, 1141, 447, 1134, 432, 14, 29, 0, 0, 1],
            [2, 192, 12, 1493, 455, 1509, 475, 1501, 465, 17, 20, 0, 0, 1],
            [3, 192, 13, 1074, 331, 1090, 341, 1082, 336, 17, 10, 0, 0, 1],
            [6, 192, 16, 1076, 499, 1098, 513, 1087, 506, 22, 13, 0, 0, 1],
            [7, 192, 17, 1046, 481, 1073, 489, 1059, 485, 27, 8, 0, 0, 1],
            [8, 192, 18, 1171, 584, 1202, 611, 1187, 597, 31, 27, 0, 0, 1],
            [4, 192, 14, 1215, 301, 1227, 319, 1221, 310, 12, 18, 0, 0, 1],
